...
function keyDown(evt){
    ...
    let strafe = (player.userData.move!==undefined) ?  player.userData.move.strafe : 0;
    ...
    playerControl(forward, strafe, turn);
}
...
function playerControl(forward, strafe, turn){
      ...
      if (player.userData.move){
        ...
        player.userData.move.strafe = strafe;
      }else{
        player.userData.move = { forward, turn, strafe, time: clock.getElapsedTime(), speed: 1 }; 
        cameraIndex = 0;
      }
		}
}
...
function update(){
  ...
  if (player.userData.move!==undefined){
    ...
    player.translateX(player.userData.move.strafe * dt * 5);
